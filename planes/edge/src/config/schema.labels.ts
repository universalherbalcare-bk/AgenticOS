...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "mcp.servers.*.kernelAuthority": "MCP Kernel Authority Risk",
  "mcp.servers.*.kernelAuthority.readOnlyTools": "MCP Read-Only Tools",
  "mcp.servers.*.kernelAuthority.risk": "MCP Tool Risk Tiers",
